    ...
    extend: {
      ...
      colors: {
        ...
        campus: {
          ...
          "teal-dark": "hsl(var(--campus-teal-dark))",
          orange: "hsl(var(--campus-orange))",
          purple: "hsl(var(--campus-purple))",
          yellow: "hsl(var(--campus-yellow))",
        },
        status: {
          diajukan: "hsl(var(--status-diajukan))",
          disetujui: "hsl(var(--status-disetujui))",
          diproses: "hsl(var(--status-diproses))",
          selesai: "hsl(var(--status-selesai))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
